<div class="container mx-auto p-8">
    ...
    <div class="flex justify-between mb-4 items-center">
        <div>
            <a href="{{route('admin.clienti.insert', $idShop)}}" wire:navigate type="button"
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td class="w-4 p-4">
                        <div class="flex items-center">
                            ...
                            <a title="audiometria" href="{{route('admin.clienti.audiometria',$client->id)}}" wire:navigate
                            ...
                            <a title="telefonate" href="{{route('admin.clienti.telefonate',$client->id)}}" wire:navigate
                            ...
                            <a title="appuntamenti" href="{{route('admin.clienti.appuntamenti',$client->id)}}" wire:navigate
