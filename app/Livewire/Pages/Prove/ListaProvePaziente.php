...
class ListaProvePaziente extends Component
{
    ...
    public function creazioneFattura(InvoiceService $invoiceService,
                                     CodeClientService $codeClientService,
                                     ClientService $clientService)
    {
        ...
        $idCodeClient = $codeClientService->findIdFromName('CL');
        $clientService->changeCodeClient($this->idClient, $idCodeClient);
        $this->chiudiModal();
    }
    ...
    {
        return view('livewire.pages.prove.lista-prove-paziente', [
